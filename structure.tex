...
\newcommand{\talksentry}[2]{
\vspace*{-1mm}
	{\raggedleft\textsc{#1{\hspace{6pt}}}} % the time period
% 	 \expandafter\ifstrequal\expandafter{#3}{}{}{{\raggedright\large\textit{\textbf{#3}}}\\[4pt]} 
	% \expandafter\ifstrequal\expandafter{#2}{}{}{{\raggedright\textbf{#2}}\\[2pt]} 
	\expandafter\ifstrequal\expandafter{#2}{}{}{#2\\} % Description
	\vspace*{-5mm}
}
