...
\vspace*{-1mm}
	...
	\expandafter\ifstrequal\expandafter{\textbf{#2}{}}{}{}{{\raggedright \textbf{#2}{}}\\}%expandafter%\ifstrequal\expandafter{#3}{}{\\}{\\[6pt]}% First the heading, then content, then a conditional insertion of whitespace if the third parameter has any content in it
