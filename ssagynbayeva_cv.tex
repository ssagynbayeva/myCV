...
%------------------------------------------------
 ...
 % Start a table with two columns, the table will ensure everything is aligned
	...
	%------------------------------------------------
	% \awardsentry{Jun 2023}  
	% {Gaussian Processes and bayesian modeling for stellar research \faMicrophone}
	\longformpublication{StanCon 2023, Washington University in St. Louis}

	% \awardsentry{Jun 2023}  
	% {How exoplanets help us understand stars \faFileImageO}
	\longformpublication{Emerging Researchers in Exoplanet Science, Yale University \faFileImageO}

	% \awardsentry{Jun 2023}  
	% {Feeding giant planets: accretion onto circumplanetary disks \faFileImageO}
	\longformpublication{Origins of Solar Systems, Gordon Research Conference \faFileImageO}

	% \awardsentry{May 2023}  
	% {Feeding giant planets: accretion onto circumplanetary disks \faMicrophone}
	\longformpublication{Athena++ workshop, Flatiron Institute (CCA)}

	% \awardsentry{Oct 2022}  
	% {Intro to Finite Volume Methods \faMicrophone}
	\longformpublication{Gravitational Waves group meeting, Flatiron Institute (CCA)}
	
	% \awardsentry{May 2022}  
	% {AGN accretion disks and black hole binaries \faMicrophone}
	\longformpublication{Seminar, University of Kansas}
