...
7. \longformpublication{Thayne Currie et al. [including \textbf{S. Sagynbayeva}]. \href{}{``SCExAO/CHARIS and Gaia Direct Imaging"} \textit{In prep} (2025).}

6. \longformpublication{Courtney Dressing et al. [including \textbf{S. Sagynbayeva}]. \href{}{``Scientific Discovery Space for the Habitable Worlds Observatory."} \textit{In prep} (2025).}
