...
%------------------------------------------------
 ...
 % Start a table with two columns, the table will ensure everything is aligned
	...
	{Emerging Researchers in Exoplanet Science, Yale University \faFileImageO}

	\talksentry{Jun 2023}  
	% {Feeding giant planets: accretion onto circumplanetary disks \faFileImageO}
	{Origins of Solar Systems, Gordon Research Conference \faFileImageO}
