...
%\medskip % Extra whitespace before the next section
\section{Science Talks \& Posters \footnotesize {\faMicrophone}\,: Talk \phantom{XX.} \footnotesize {\faFileImageO}\,: Poster \phantom{XX.}}
...
%------------------------------------------------
 ...
 % Start a table with two columns, the table will ensure everything is aligned
	...
	{Emerging Researchers in Exoplanet Science, Yale University}
	...
	{Athena++ workshop, Flatiron Institute (CCA)}
