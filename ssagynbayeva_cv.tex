...
16. \longformpublication{\textbf{Sabina Sagynbayeva} et al. \href{}{``Occurrence Rates Based on Chemical Abundances of K2 Planets."} \textit{In prep, expected submission Dec 2025}.}

15. \longformpublication{\textbf{Sabina Sagynbayeva} et al. \href{}{``Rotation Periods for Stars in Open Cluster NGC 6819 From Kepler Light Curves."} \textit{In review}.}

14. \longformpublication{\textbf{Sabina Sagynbayeva} et al. \href{}{``Polka-dotted Stars II: Starspost and Obliquities of HAT-P-11, Kepler-17, Kepler-45, Kepler-63."} \textit{In review}.}

13. \longformpublication{\textbf{Sabina Sagynbayeva} et al. \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250421852S/abstract}{``Polka-dotted Stars: a Hierarchical Model for Mapping Stellar Surfaces Using Occultation Light Curves."} \textit{ApJ} (2025).}

12. \longformpublication{\textbf{Sabina Sagynbayeva} et al. \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250721443S/abstract}{``Requirements for Joint Orbital Characterization of Cold Giants and Habitable Worlds with Habitable
Worlds Observatory."} \textit{AJ} (2025).}

11. \longformpublication{\textbf{Sabina Sagynbayeva} et al. \href{https://ui.adsabs.harvard.edu/abs/2024arXiv241014896S/abstract}{``Circumplanetary Disks are Rare around Planets at Large Orbital Radii: A Parameter Survey of Flow Morphology around Giant Planets."} \textit{ApJ} (2025).}

10. \longformpublication{Daniele Malafarina, \textbf{Sabina Sagynbayeva}. \href{https://trebuchet.public.springernature.app/get_content/e19b1eb6-daac-4e48-a946-f55457e622aa}{``What a difference a quadrupole makes?"} \textit{General Relativity and Gravitation} (2021).}


\section{Publications: Nth author}
%------------------------------------------------
9. \longformpublication{Elisabeth Newton et al. [including \textbf{S. Sagynbayeva}]. \href{}{``The role of stellar multiplicity in the prevalence of small, cool
planets"} \textit{In prep} (2025).}

8. \longformpublication{Mona El Morsy et al. [including \textbf{S. Sagynbayeva}]. \href{}{``OASIS Survey Direct Imaging and Astrometric Discovery of HIP 71618 B:
A Substellar Companion Suitable for the Roman Coronagraph Instrument Technology Demonstration"} \textit{In review} (2025).}

7. \longformpublication{Thayne Currie et al. [including \textbf{S. Sagynbayeva}]. \href{}{``SCExAO/CHARIS and Gaia Direct Imaging and Astrometric Discovery of a Superjovian Planet 3-4 $\lambda/D$ from the Accelerating Star HIP 54515"} \textit{In review} (2025).}

6. \longformpublication{Courtney Dressing et al. [including \textbf{S. Sagynbayeva}]. \href{}{``Scientific Discovery Space for the Habitable Worlds Observatory."} \textit{In review} (2025).}

5. \longformpublication{Sarah Blunt et al. [including \textbf{S. Sagynbayeva}]. \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250706188B/abstract}{``A Statistical Method for Constraining the Capability of the Habitable Worlds Observatory to Understand Ozone Onset Time in Earth Analogs."} \textit{JATIS} (2025).}

4. \longformpublication{Rachel B. Fernandes et al. [including \textbf{S. Sagynbayeva}]. \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250310856F/abstract}{``Signatures of Atmospheric Mass Loss and Planet Migration in the Time Evolution of Short-Period Transiting Exoplanets."} \textit{The Astronomical Journal} (2025).}

3. \longformpublication{Briley Lewis et al. [including \textbf{S. Sagynbayeva}]. \href{https://ui.adsabs.harvard.edu/abs/2023arXiv230905822L/abstract}{``Exploring the Effects of Astrobites Lesson Plans on Undergraduate Astronomy Students."} \textit{Physical Review Physics Education Research} (2025).}

2. \longformpublication{Thayne Currie et al. [including \textbf{S. Sagynbayeva}]. \href{https://arxiv.org/abs/2212.00034}{``Direct Imaging and Astrometric Discovery of a Superjovian Planet Orbiting an Accelerating Star."} \textit{Science} (2023).}

1. \longformpublication{D. Alina et al. [including \textbf{S. Sagynbayeva}]. \href{https://arxiv.org/abs/2007.15344}{``Large-scale magnetic field in the Monoceros OB-1 East molecular cloud."} \textit{Astronomy \& Astrophysics} (2020).}
...
%------------------------------------------------
 ...
 % Start a table with two columns, the table will ensure everything is aligned
	...
	{I was selected for the opportunity for advanced physics doctoral students to spend a minimum period of 5 months at the Kavli Institute for Theoretical Physics.} % parameter 3

	\awardsentry{2024}  % parameter 1
	{Peter Kahn Prize} % parameter 2
	{An award for "outstanding research" for which I was nominated by my academic advisor.} % parameter 3
	...
	{I was selected for the program that allows to visit UC Santa Cruz for three weeks to work on a project with an UCSC faculty.} % parameter 3
	...
	{I was selected for the program that consists of six week-long sessions on data science.} % parameter 3
...
%\medskip % Extra whitespace before the next section
\section{Selected Invited (16) \& Conference Talks}
...
%------------------------------------------------
 ...
 % Start a table with two columns, the table will ensure everything is aligned
	...
	%------------------------------------------------
	\talks{Exoplanet seminar, Space Telescope Science Institute}{Dec 2025}

	\talks{Carnegie EPL Astronomy Seminar, Carnegie Institution for Science}{Oct 2025}

	\talks{Stars \& Planets workshop, MIT}{Aug 2025}
...
\begin{tabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	{} % Degree
	{Python, Julia, C/C++, IDL, HTML, JavaScript, Mathematica, \LaTeX} % Department
	{} %Honours
	{} % Institution
	{}
	...
	\educationentry{Statistical skills} % Duration
	{} % Degree
	{Hierarchical Bayesian Models, Gaussian Processes, MCMC sampling} % Department
	{} %Honours
	{} % Institution
	{}
	%------------------------------------------------
